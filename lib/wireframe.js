import * as CANVAS from "./canvas_init.js";
...
export const objectInputParser = function() {
...
/* Get board */
export const getBoard = function(boardId) {
    var board;
...
/* Rendering canvas */
export const renderCanvas = function(boardId, objectList) {
